...
// unique_serializable is class that can be found in common / serialization and is used to assign unique ids to game / player ...
// game state inherits from UniqueSerializable
...
// this part can only be accessed by server and not by client
#ifdef LAMA_SERVER
